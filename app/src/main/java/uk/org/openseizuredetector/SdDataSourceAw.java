...
public class SdDataSourceAw extends SdDataSource {
    ...
    public void stop() {
        ...
        try {
            ...
            mUtil.writeToSysLogFile("SdDataSourceAw.stop() - error - " + e);
        }
    }
    ...
    public void updatePrefs() {
        ...
        try {
            ...
            mUtil.writeToSysLogFile("SdDataSourceAw.updatePrefs() - ERROR " + ex);
    ...
    public void stopPebbleServer() {
        ...
        try {
            ...
            mUtil.writeToSysLogFile("SdDataSourceAw.stopServer() - error " + e);
        }
    }
