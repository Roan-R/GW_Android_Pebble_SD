...
#
# Detects all 4 seizure types seen in this child (SCN8A, 3 years old):
...
#
# Thresholds calibrated from 7 days of real session data.
...
# HR — this child's profile (from 7 days of data)
