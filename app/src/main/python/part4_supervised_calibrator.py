...
def build_sample_weight(rows: list,
    ...
    Startle seizures are upweighted because this patient has many startle
    events and those are the ones we most need the app to stop missing.
    """
